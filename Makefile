...
#     ABSTRACT => q[Catalyst Application]
#     AUTHOR => q[metaperl,,,]
#     DIR => []
#     DISTNAME => q[MyApp]
...
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Catalyst=>q[5.60] }
#     VERSION => q[0.01]
#     dist => { PREOP=>q[$(PERL) -I. -MModule::Install::Admin -e "dist_preop(q($(DISTVNAME)))"] }
#     test => { TESTS=>q[t/01app.t t/02pod.t t/03podcoverage.t t/view_Seamstress.t] }
...
TO_INST_PM = lib/HTML/Seamstress/Base.pm \
	lib/MyApp.pm \
	lib/MyApp/View/Seamstress.pm \
	lib/MyApp/View/Seamstress.pm.new

PM_TO_BLIB = lib/MyApp/View/Seamstress.pm.new \
	blib/lib/MyApp/View/Seamstress.pm.new \
	lib/MyApp.pm \
	blib/lib/MyApp.pm \
	lib/HTML/Seamstress/Base.pm \
	blib/lib/HTML/Seamstress/Base.pm \
	lib/MyApp/View/Seamstress.pm \
	blib/lib/MyApp/View/Seamstress.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW)\
	  ...
	  lib/MyApp/View/Seamstress.pm $(INST_MAN3DIR)/MyApp::View::Seamstress.$(MAN3EXT) 
...
realclean ::
	$(RM_F) $(INST_SCRIPT)/myapp_server.pl $(INST_SCRIPT)/myapp_create.pl $(INST_SCRIPT)/myapp_cgi.pl $(INST_SCRIPT)/myapp_fastcgi.pl $(INST_SCRIPT)/myapp_test.pl

$(INST_SCRIPT)/myapp_server.pl: script/myapp_server.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)/.exists
...
$(INST_SCRIPT)/myapp_create.pl: script/myapp_create.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)/.exists
...
$(INST_SCRIPT)/myapp_cgi.pl: script/myapp_cgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)/.exists
...
$(INST_SCRIPT)/myapp_fastcgi.pl: script/myapp_fastcgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)/.exists
...
$(INST_SCRIPT)/myapp_test.pl: script/myapp_test.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)/.exists
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/MyApp/View/Seamstress.pm.new blib/lib/MyApp/View/Seamstress.pm blib/lib/HTML/Seamstress/Base.pm blib/lib/MyApp.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
TEST_FILE = test.pl
TEST_FILES = t/01app.t t/02pod.t t/03podcoverage.t t/view_Seamstress.t
TESTDB_SW = -d
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Catalyst Application</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>metaperl,,,</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Catalyst" VERSION="5,60,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/MyApp/View/Seamstress.pm.new blib/lib/MyApp/View/Seamstress.pm.new \
	  lib/MyApp.pm blib/lib/MyApp.pm \
	  lib/HTML/Seamstress/Base.pm blib/lib/HTML/Seamstress/Base.pm \
	  lib/MyApp/View/Seamstress.pm blib/lib/MyApp/View/Seamstress.pm 
	$(NOECHO) $(TOUCH) $@
...
# End.
# Postamble by Module::Install 0.46
